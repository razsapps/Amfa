...
public class MillennialMediaAdProvider implements IAdProvider {
	@Override
	public String getProviderName() {
		return "millennial_media";
	}
	
	@Override
	public IInterstitialAd createInterstitialAd(AdRequestMetaData... metaDatas) {
		return new MillennialMediaInterstitialAd(metaDatas);
	}

	@Override
	public String getIdentifierClass() {
		return "com.millennialmedia.android.MMActivity";
	}
}
